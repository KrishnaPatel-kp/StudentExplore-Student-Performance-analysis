...
if (isset($_POST['hsc_submit'])) {
    ...
    $edit_query = mysqli_query($con, "UPDATE hsc_edu_data SET H_schoolname='$hsc_schoolname', H_board='$hsc_board', H_month='$hsc_month', H_year='$hsc_year', H_percentage='$hsc_pg', H_percentile='$hsc_pr', H_grade='$hsc_grade' WHERE Enroll_id=$id ") or die("error occurred");
...
$edit_query1 = mysqli_query($con, "SELECT*FROM hsc_edu_data WHERE Enroll_id=$id ");
...
<head>
    ...
    <title>educational details edit form-hsc</title>
    ...
    <center>
        ...
        <div class="container1">
            <div class="box form-box1">
                <header>Edit Higher Secondary State Examination [HSC] Details</header>
                    ...
                    <div class="field input">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="field">
                                        <input type="submit" class="btn" name="hsc_submit" value="update" required>
                                    </div>
                                </td>
                            </tr>
                        </table>
