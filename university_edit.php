...
if (isset($_POST['uni_submit'])) {
    ...
    $edit_query = mysqli_query($con, "UPDATE university_data SET Uni_name='$uni_name', Uni_department='$uni_dep', Uni_course='$uni_course', Sem1='$s1', Sem2='$s2', Sem3='$s3', Sem4='$s4', Sem5='$s5', Sem6='$s6', Uni_sgpa='$uni_sgpa' WHERE Enroll_id=$id ") or die("error occurred");
...
<head>
    ...
    <title>university Graduation edit form</title>
    ...
    <center>
        ...
        <div class="container1">
            <div class="box form-box1">
                <header>Edit Graduation Details</header>
                    ...
                    <div class="field input">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="field">
                                        <input type="submit" class="btn" name="uni_submit" value="update" required>
                                    </div>
                                </td>
                            </tr>
                        </table>
