...
<head>
    ...
    <title>View educational details-hsc </title>
...
<body>
    ...
    <center>
        ...
        <div>
            ...
            <a href="educationaldetails_hsc_edit.php">update details</a>
        </div>
        <div class="container1">
            <div class="box form-box1">

                <header>Higher Secondary State Examination [HSC] Details</header>
                        ...
                        <table>
                            <tr>
                                <td>
                                    School Name
                                <td>
                                    <p id="viewdata"><?php echo $res_hsc_schoolname; ?></p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p id="viewdata"><?php echo $res_hsc_month; ?></p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <p id="viewdata"><?php echo $res_hsc_year; ?></p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <p id="viewdata"><?php echo $res_hsc_pg; ?></p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <p id="viewdata"><?php echo $res_hsc_pr; ?></p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <p id="viewdata"><?php echo $res_hsc_grade; ?></p>
                                </td>
                            </tr>
                        </table>
                    </div>
                ...
                <div class="extralinks">
                    <a href="visualization_hsc.php">compare yourself with others</a>
                </div>
            </div>
