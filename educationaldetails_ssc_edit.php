...
if (isset($_POST['ssc_submit'])) {
    ...
    $edit_query = mysqli_query($con, "UPDATE ssc_edu_data SET S_schoolname='$ssc_schoolname', S_board='$ssc_board', S_month='$ssc_month', S_year='$ssc_year', S_percentage='$ssc_pg', S_percentile='$ssc_pr', S_grade='$ssc_grade' WHERE Enroll_id=$id ") or die("error occurred");
...
$edit_query1 = mysqli_query($con, "SELECT*FROM ssc_edu_data WHERE Enroll_id=$id ");
...
<head>
    ...
    <title>educational details edit form - ssc</title>
    ...
    <center>
        ...
        <div class="container1">
            <div class="box form-box1">
                <header>Edit Secondary State Examination [SSC] Details</header>
                    ...
                    <div class="field input">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="ssc_grade" id="ssc_grdae" value="<?php echo $res_ssc_grade; ?>" autocomplete="off" required placeholder="A1-A2-B1-B2-C1-C2">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <div class="field">
                                        <input type="submit" class="btn" name="ssc_submit" value="update" required>
                                    </div>
                                </td>
                            </tr>
                        </table>
