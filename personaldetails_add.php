...
if (isset($_POST['personaldetail_submit'])) {
    ...
    $insert_query = "INSERT INTO personal_details(Enroll_id, Firstname, Lastname, Gender, Birthdate, State, Country, Contact_number, Education_qualification) 
                    VALUES('$id', '$fname', '$lname', '$gender', '$bdate', '$state', '$country', '$contact', '$edu_qualification')";
...
<head>
    ...
    <title>personal details add form</title>
...
<body>
    ...
    <center>
        ...
        <div>
            <p>If you already insert data then please <a href="personaldetails_edit.php"><span style="color: blue;">update</span></a> your details .</p>
        </div>
        <div class="container1">
            <div class="box form-box1">
                ...
                <header>Add Personal Details</header>
                <form action="" method="post">
                    <div class="field input">
                        <table>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="date" name="birthdate" id="birthdate" value="<?php echo $res_bdate ?>" autocomplete="off">
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="field">
                                        <input type="submit" class="btn" name="personaldetail_submit" value="submit" required>
                                    </div>
                                </td>
                            </tr>
                        </table>
